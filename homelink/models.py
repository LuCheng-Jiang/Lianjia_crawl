...
class HouseInfo(models.Model):
    ...
    # district_abbr = models.CharField(max_length=20,verbose_name="地区")
    # price_abbr = models.CharField(max_length=20,verbose_name="价格区间")
    # bedroom_abbr = models.CharField(max_length=20,verbose_name="几室")
